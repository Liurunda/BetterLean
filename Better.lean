...
理论计算机科学之于计算机软硬件工程，就像物理学之于机械工程。

大多数机械工程师不需要深入探讨物理学，只需要使用一些机械设计手册里的经验公式。
但追求极致的精密仪器、巨型机械，
常常遇到经验公式失效的时候，就必须回到物理学来进行推导了。

Lean is a tool created by experts, for experts.

It's unfriendly to beginners.

我认为，每种编程语言都应该有一个“Beginner Version"和一个”Expert Version".
正如人类儿童学习语言一定不是从学术论文开始学最精准高效的学术语言，
而是先学会和爸爸妈妈的简单交流。

让我们实现一个BlockLean，使用类似scratch的积木化编程来讲授lean。
-/
